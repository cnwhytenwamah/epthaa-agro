    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 text-center hover:shadow-xl transition">
                ...
                <p class="text-gray-600 mb-2">Send us an email</p>
                <a href="mailto:info@epthaaagro.com" class="text-primary hover:text-secondary font-semibold">
                    info@epthaaagro.com
                </a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="subject" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                    </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="h-96 bg-gray-200">
                        <iframe 
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.010!2d3.3792!3d6.5244!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMzEnMjcuOCJOIDPCsDIyJzQ1LjEiRQ!5e0!3m2!1sen!2sng!4v1234567890"
                            width="100%" 
                            height="100%" 
                            style="border:0;" 
                            allowfullscreen="" 
                ...
                <!-- WhatsApp CTA -->
                <div class="bg-green-600 rounded-lg shadow-md p-8 text-white text-center">
                    ...
                    <h3 class="text-2xl font-bold mb-2">Chat With Us on WhatsApp</h3>
                    <p class="mb-6">Get instant responses to your queries</p>
                    <a href="https://wa.me/{{ env('WHATSAPP_NUMBER') }}" target="_blank" class="inline-block bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition">
                        Start Chat
                    </a>
                </div>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold text-gray-900 mb-4">Follow Us on Social Media</h2>
        <p class="text-gray-600 mb-8">Stay updated with our latest news and offers</p>
        
        <div class="flex justify-center space-x-6">
            <a href="#" class="bg-white rounded-full p-4 shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
